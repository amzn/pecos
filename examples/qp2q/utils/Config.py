...
class Config(object):
    def __init__(self, filename=None):
        ...
        self.query_prefix_delimiter = "<@@>" # Delimiter used when concatenating query and prefix in the input
        ...
        self.depth = -1 # This is used for depth of Trie Index, or together with must-link-constraints etc

        self.imb_depth = 100 # imbalance_depth param used for Hierarchical kmeans
        self.imb_ratio = 0.  # imbalance_ratio param used for Hierarchical kmeans
